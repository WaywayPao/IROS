...
class PDResNet(nn.Module):
    ...
    def __init__(self, block, layers, channel=3, num_classes=1000):
        ...
        self.conv1 = PartialConv2d(channel, 64, kernel_size=7, stride=2, padding=3,
                                   bias=False)
...
def pdresnet50(pretrained=False, channel=3, **kwargs):
    ...
    model = PDResNet(Bottleneck, [3, 4, 6, 3], channel=channel, **kwargs)
